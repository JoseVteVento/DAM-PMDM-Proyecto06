...
public class Amor extends ListActivity {


    private static String TAG ="amor";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor c = db.rawQuery("SELECT * FROM amor_odio WHERE amor_odio = '1'", new String[]{});
        ...
        boton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Amor.this, Formulario.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
         ...
         if (resultCode == RESULT_OK) {
             ...
             Cursor c = db.rawQuery
                     ("SELECT * FROM amor_odio WHERE amor_odio = '1'", new String[]{});
