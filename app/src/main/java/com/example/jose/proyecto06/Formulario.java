...
public class Formulario extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //guardado_en = (TextView)findViewById(R.id.label_guardado_en);
    ...
    private void consultar(long id)
    {
        ...
        //foto.setImageURI((Uri.parse(cursor.getString(cursor.getColumnIndex(DataBaseHelper.DESCRIPCION)))));
